...
fp64_to_int(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   exec_list *const f0899_parent_instructions = body.instructions;
      ...
      exec_list *const f089B_parent_instructions = body.instructions;
         ...
         ir_variable *const r08A3 = body.make_temp(glsl_type::int_type, "conditional_tmp");
         /* IF CONDITION */
         ir_expression *const r08A5 = expr(ir_unop_u2i, r0892);
         ir_expression *const r08A6 = expr(ir_unop_i2b, r08A5);
         ...
         exec_list *const f08A4_parent_instructions = body.instructions;
            ...
            body.emit(assign(r08A3, body.constant(int(-2147483648)), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f08A4->else_instructions;

            body.emit(assign(r08A3, body.constant(int(2147483647)), 0x01));
         ...
         body.emit(assign(r0890, r08A3, 0x01));
         ...
         ir_variable *const r08A7 = body.make_temp(glsl_type::uint_type, "a0");
         body.emit(assign(r08A7, bit_or(r0894, body.constant(1048576u)), 0x01));

         ir_expression *const r08A8 = equal(r0898, body.constant(int(0)));
         ir_expression *const r08A9 = lshift(r08A7, r0898);
         ir_expression *const r08AA = neg(r0898);
         ir_expression *const r08AB = bit_and(r08AA, body.constant(int(31)));
         ir_expression *const r08AC = rshift(swizzle_x(r088E), r08AB);
         ir_expression *const r08AD = bit_or(r08A9, r08AC);
         body.emit(assign(r0891, expr(ir_triop_csel, r08A8, r08A7, r08AD), 0x01));
      ...
      /* IF CONDITION */
      ir_expression *const r08AF = less(r0895, body.constant(int(1023)));
      ...
      exec_list *const f08AE_parent_instructions = body.instructions;
         ...
         ir_expression *const r08B0 = neg(r0898);
         body.emit(assign(r0891, rshift(r0893, r08B0), 0x01));
   ...
   /* IF CONDITION */
   ir_if *f08B1 = new(mem_ctx) ir_if(operand(r088F).val);
   exec_list *const f08B1_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r08B4 = nequal(r0892, body.constant(0u));
      ...
      exec_list *const f08B3_parent_instructions = body.instructions;
         ...
         ir_expression *const r08B5 = expr(ir_unop_u2i, r0891);
         body.emit(assign(r08B2, neg(r08B5), 0x01));


         /* ELSE INSTRUCTIONS */
         body.instructions = &f08B3->else_instructions;

         body.emit(assign(r08B2, expr(ir_unop_u2i, r0891), 0x01));
      ...
      /* IF CONDITION */
      ir_expression *const r08B7 = less(r08B2, body.constant(int(0)));
      ir_expression *const r08B8 = expr(ir_unop_b2i, r08B7);
      ir_expression *const r08B9 = expr(ir_unop_i2u, r08B8);
      ir_expression *const r08BA = bit_xor(r0892, r08B9);
      ir_expression *const r08BB = expr(ir_unop_u2i, r08BA);
      ir_expression *const r08BC = expr(ir_unop_i2b, r08BB);
      ir_expression *const r08BD = expr(ir_unop_i2b, r08B2);
      ir_expression *const r08BE = logic_and(r08BC, r08BD);
      ir_if *f08B6 = new(mem_ctx) ir_if(operand(r08BE).val);
      exec_list *const f08B6_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f08B6->then_instructions;

         ir_variable *const r08BF = body.make_temp(glsl_type::int_type, "conditional_tmp");
         /* IF CONDITION */
         ir_expression *const r08C1 = expr(ir_unop_u2i, r0892);
         ir_expression *const r08C2 = expr(ir_unop_i2b, r08C1);
         ...
         exec_list *const f08C0_parent_instructions = body.instructions;
            ...
            body.emit(assign(r08BF, body.constant(int(-2147483648)), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f08C0->else_instructions;

            body.emit(assign(r08BF, body.constant(int(2147483647)), 0x01));
         ...
         body.emit(assign(r0890, r08BF, 0x01));
         ...
         body.emit(assign(r0890, r08B2, 0x01));
...
int_to_fp64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r08C3 = new(mem_ctx) ir_variable(glsl_type::int_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r08C3);
   ir_variable *const r08C4 = body.make_temp(glsl_type::uvec2_type, "return_value");
   ir_variable *const r08C5 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zSign", ir_var_auto);
   body.emit(r08C5);
   ir_variable *const r08C6 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zFrac1", ir_var_auto);
   body.emit(r08C6);
   ir_variable *const r08C7 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zFrac0", ir_var_auto);
   body.emit(r08C7);
   body.emit(assign(r08C7, body.constant(0u), 0x01));

   body.emit(assign(r08C6, body.constant(0u), 0x01));

   /* IF CONDITION */
   ir_expression *const r08C9 = equal(r08C3, body.constant(int(0)));
   ...
   exec_list *const f08C8_parent_instructions = body.instructions;
      ...
      ir_variable *const r08CA = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
      body.emit(r08CA);
      body.emit(assign(r08CA, body.constant(0u), 0x02));

      body.emit(assign(r08CA, body.constant(0u), 0x01));

      body.emit(assign(r08C4, r08CA, 0x03));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f08C8->else_instructions;

      ir_expression *const r08CB = less(r08C3, body.constant(int(0)));
      ir_expression *const r08CC = expr(ir_unop_b2i, r08CB);
      body.emit(assign(r08C5, expr(ir_unop_i2u, r08CC), 0x01));

      ir_variable *const r08CD = body.make_temp(glsl_type::uint_type, "conditional_tmp");
      /* IF CONDITION */
      ir_expression *const r08CF = less(r08C3, body.constant(int(0)));
      ...
      exec_list *const f08CE_parent_instructions = body.instructions;
         ...
         ir_expression *const r08D0 = neg(r08C3);
         body.emit(assign(r08CD, expr(ir_unop_i2u, r08D0), 0x01));


         /* ELSE INSTRUCTIONS */
         body.instructions = &f08CE->else_instructions;

         body.emit(assign(r08CD, expr(ir_unop_i2u, r08C3), 0x01));
      ...
      ir_variable *const r08D1 = body.make_temp(glsl_type::int_type, "assignment_tmp");
      ir_expression *const r08D2 = equal(r08CD, body.constant(0u));
      ir_expression *const r08D3 = expr(ir_unop_find_msb, r08CD);
      ...
      body.emit(assign(r08D1, add(r08D5, body.constant(int(-11))), 0x01));

      /* IF CONDITION */
      ir_expression *const r08D7 = gequal(r08D1, body.constant(int(0)));
      ...
      exec_list *const f08D6_parent_instructions = body.instructions;
         ...
         body.emit(assign(r08C7, lshift(r08CD, r08D1), 0x01));
         ...
         ir_variable *const r08D8 = body.make_temp(glsl_type::int_type, "count");
         body.emit(assign(r08D8, neg(r08D1), 0x01));

         ir_expression *const r08D9 = equal(r08D8, body.constant(int(0)));
         ir_expression *const r08DA = less(r08D8, body.constant(int(32)));
         ir_expression *const r08DB = rshift(r08CD, r08D8);
         ir_expression *const r08DC = expr(ir_triop_csel, r08DA, r08DB, body.constant(0u));
         body.emit(assign(r08C7, expr(ir_triop_csel, r08D9, r08CD, r08DC), 0x01));

         ir_expression *const r08DD = equal(r08D8, body.constant(int(0)));
         ir_expression *const r08DE = less(r08D8, body.constant(int(32)));
         ir_expression *const r08DF = neg(r08D8);
         ir_expression *const r08E0 = bit_and(r08DF, body.constant(int(31)));
         ir_expression *const r08E1 = lshift(r08CD, r08E0);
         ir_expression *const r08E2 = bit_or(r08E1, body.constant(0u));
         ir_expression *const r08E3 = less(r08D8, body.constant(int(64)));
         ir_expression *const r08E4 = bit_and(r08D8, body.constant(int(31)));
         ir_expression *const r08E5 = rshift(r08CD, r08E4);
         ir_expression *const r08E6 = expr(ir_triop_csel, r08E3, r08E5, body.constant(0u));
         ir_expression *const r08E7 = expr(ir_triop_csel, r08DE, r08E2, r08E6);
         body.emit(assign(r08C6, expr(ir_triop_csel, r08DD, r08CD, r08E7), 0x01));
      ...
      body.emit(r08E8);
      ir_expression *const r08E9 = lshift(r08C5, body.constant(int(31)));
      ir_expression *const r08EA = sub(body.constant(int(1042)), r08D1);
      ir_expression *const r08EB = expr(ir_unop_i2u, r08EA);
      ir_expression *const r08EC = lshift(r08EB, body.constant(int(20)));
      ir_expression *const r08ED = add(r08E9, r08EC);
      body.emit(assign(r08E8, add(r08ED, r08C7), 0x02));

      body.emit(assign(r08E8, r08C6, 0x01));

      body.emit(assign(r08C4, r08E8, 0x03));
...
packFloat32(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r08EE = new(mem_ctx) ir_variable(glsl_type::uint_type, "zSign", ir_var_function_in);
   sig_parameters.push_tail(r08EE);
   ir_variable *const r08EF = new(mem_ctx) ir_variable(glsl_type::int_type, "zExp", ir_var_function_in);
   sig_parameters.push_tail(r08EF);
   ir_variable *const r08F0 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zFrac", ir_var_function_in);
   sig_parameters.push_tail(r08F0);
   ir_variable *const r08F1 = body.make_temp(glsl_type::float_type, "uintBitsToFloat_retval");
   ir_expression *const r08F2 = lshift(r08EE, body.constant(int(31)));
   ir_expression *const r08F3 = expr(ir_unop_i2u, r08EF);
   ir_expression *const r08F4 = lshift(r08F3, body.constant(int(23)));
   ir_expression *const r08F5 = add(r08F2, r08F4);
   ir_expression *const r08F6 = add(r08F5, r08F0);
   body.emit(assign(r08F1, expr(ir_unop_bitcast_u2f, r08F6), 0x01));
...
roundAndPackFloat32(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r08F7 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zSign", ir_var_function_in);
   sig_parameters.push_tail(r08F7);
   ir_variable *const r08F8 = new(mem_ctx) ir_variable(glsl_type::int_type, "zExp", ir_var_function_in);
   sig_parameters.push_tail(r08F8);
   ir_variable *const r08F9 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zFrac", ir_var_function_in);
   sig_parameters.push_tail(r08F9);
   ir_variable *const r08FA = body.make_temp(glsl_type::bool_type, "execute_flag");
   body.emit(assign(r08FA, body.constant(true), 0x01));

   ir_variable *const r08FB = body.make_temp(glsl_type::float_type, "return_value");
   ir_variable *const r08FC = new(mem_ctx) ir_variable(glsl_type::int_type, "roundBits", ir_var_auto);
   body.emit(r08FC);
   ir_expression *const r08FD = bit_and(r08F9, body.constant(127u));
   body.emit(assign(r08FC, expr(ir_unop_u2i, r08FD), 0x01));

   /* IF CONDITION */
   ir_expression *const r08FF = expr(ir_unop_i2u, r08F8);
   ir_expression *const r0900 = gequal(r08FF, body.constant(253u));
   ...
   exec_list *const f08FE_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r0902 = less(body.constant(int(253)), r08F8);
      ir_expression *const r0903 = equal(r08F8, body.constant(int(253)));
      ir_expression *const r0904 = expr(ir_unop_u2i, r08F9);
      ir_expression *const r0905 = less(r0904, body.constant(int(-64)));
      ir_expression *const r0906 = logic_and(r0903, r0905);
      ir_expression *const r0907 = logic_or(r0902, r0906);
      ir_if *f0901 = new(mem_ctx) ir_if(operand(r0907).val);
      exec_list *const f0901_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0901->then_instructions;

         ir_expression *const r0908 = lshift(r08F7, body.constant(int(31)));
         ir_expression *const r0909 = add(r0908, body.constant(2139095040u));
         body.emit(assign(r08FB, expr(ir_unop_bitcast_u2f, r0909), 0x01));

         body.emit(assign(r08FA, body.constant(false), 0x01));


         /* ELSE INSTRUCTIONS */
         body.instructions = &f0901->else_instructions;

         ir_variable *const r090A = body.make_temp(glsl_type::int_type, "assignment_tmp");
         body.emit(assign(r090A, neg(r08F8), 0x01));

         ir_variable *const r090B = body.make_temp(glsl_type::bool_type, "assignment_tmp");
         body.emit(assign(r090B, less(r08F8, body.constant(int(0))), 0x01));

         ir_variable *const r090C = body.make_temp(glsl_type::uint_type, "mix_retval");
         ir_expression *const r090D = neg(r08F8);
         ir_expression *const r090E = less(r090D, body.constant(int(32)));
         ir_expression *const r090F = rshift(r08F9, r090A);
         ir_expression *const r0910 = neg(r090A);
         ir_expression *const r0911 = bit_and(r0910, body.constant(int(31)));
         ir_expression *const r0912 = lshift(r08F9, r0911);
         ir_expression *const r0913 = nequal(r0912, body.constant(0u));
         ir_expression *const r0914 = expr(ir_unop_b2i, r0913);
         ir_expression *const r0915 = expr(ir_unop_i2u, r0914);
         ir_expression *const r0916 = bit_or(r090F, r0915);
         ir_expression *const r0917 = nequal(r08F9, body.constant(0u));
         ir_expression *const r0918 = expr(ir_unop_b2i, r0917);
         ir_expression *const r0919 = expr(ir_unop_i2u, r0918);
         ir_expression *const r091A = expr(ir_triop_csel, r090E, r0916, r0919);
         body.emit(assign(r090C, expr(ir_triop_csel, r090B, r091A, r08F9), 0x01));

         body.emit(assign(r08F9, r090C, 0x01));

         ir_expression *const r091B = expr(ir_unop_u2i, r090C);
         ir_expression *const r091C = bit_and(r091B, body.constant(int(127)));
         body.emit(assign(r08FC, expr(ir_triop_csel, r090B, r091C, r08FC), 0x01));

         body.emit(assign(r08F8, expr(ir_triop_csel, r090B, body.constant(int(0)), r08F8), 0x01));
   ...
   /* IF CONDITION */
   ir_if *f091D = new(mem_ctx) ir_if(operand(r08FA).val);
   exec_list *const f091D_parent_instructions = body.instructions;

      /* THEN INSTRUCTIONS */
      body.instructions = &f091D->then_instructions;

      ir_expression *const r091E = add(r08F9, body.constant(64u));
      body.emit(assign(r08F9, rshift(r091E, body.constant(int(7))), 0x01));

      ir_expression *const r091F = bit_xor(r08FC, body.constant(int(64)));
      ir_expression *const r0920 = equal(r091F, body.constant(int(0)));
      ir_expression *const r0921 = expr(ir_unop_b2i, r0920);
      ir_expression *const r0922 = expr(ir_unop_i2u, r0921);
      ir_expression *const r0923 = expr(ir_unop_bit_not, r0922);
      body.emit(assign(r08F9, bit_and(r08F9, r0923), 0x01));

      ir_expression *const r0924 = lshift(r08F7, body.constant(int(31)));
      ir_expression *const r0925 = equal(r08F9, body.constant(0u));
      ir_expression *const r0926 = expr(ir_triop_csel, r0925, body.constant(int(0)), r08F8);
      ir_expression *const r0927 = expr(ir_unop_i2u, r0926);
      ir_expression *const r0928 = lshift(r0927, body.constant(int(23)));
      ir_expression *const r0929 = add(r0924, r0928);
      ir_expression *const r092A = add(r0929, r08F9);
      body.emit(assign(r08FB, expr(ir_unop_bitcast_u2f, r092A), 0x01));
...
fp64_to_fp32(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r092B = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r092B);
   ir_variable *const r092C = body.make_temp(glsl_type::float_type, "return_value");
   ir_variable *const r092D = body.make_temp(glsl_type::uint_type, "extractFloat64FracLo_retval");
   body.emit(assign(r092D, swizzle_x(r092B), 0x01));

   ir_variable *const r092E = body.make_temp(glsl_type::uint_type, "extractFloat64FracHi_retval");
   body.emit(assign(r092E, bit_and(swizzle_y(r092B), body.constant(1048575u)), 0x01));

   ir_variable *const r092F = body.make_temp(glsl_type::int_type, "extractFloat64Exp_retval");
   ir_expression *const r0930 = rshift(swizzle_y(r092B), body.constant(int(20)));
   ...
   body.emit(assign(r0932, rshift(swizzle_y(r092B), body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r0934 = equal(r092F, body.constant(int(2047)));
   ...
   exec_list *const f0933_parent_instructions = body.instructions;
      ...
      ir_variable *const r0935 = new(mem_ctx) ir_variable(glsl_type::float_type, "rval", ir_var_auto);
      body.emit(r0935);
      ir_variable *const r0936 = body.make_temp(glsl_type::uint_type, "z1Ptr");
      body.emit(assign(r0936, lshift(swizzle_x(r092B), body.constant(int(12))), 0x01));

      ir_expression *const r0937 = lshift(swizzle_y(r092B), body.constant(int(12)));
      ir_expression *const r0938 = rshift(swizzle_x(r092B), body.constant(int(20)));
      body.emit(assign(r092B, bit_or(r0937, r0938), 0x02));

      body.emit(assign(r092B, r0936, 0x01));

      ir_expression *const r0939 = lshift(r0932, body.constant(int(31)));
      ir_expression *const r093A = bit_or(r0939, body.constant(2143289344u));
      ir_expression *const r093B = rshift(swizzle_y(r092B), body.constant(int(9)));
      ir_expression *const r093C = bit_or(r093A, r093B);
      body.emit(assign(r0935, expr(ir_unop_bitcast_u2f, r093C), 0x01));

      ir_variable *const r093D = body.make_temp(glsl_type::float_type, "mix_retval");
      ir_expression *const r093E = bit_or(r092E, r092D);
      ir_expression *const r093F = nequal(r093E, body.constant(0u));
      ir_expression *const r0940 = lshift(r0932, body.constant(int(31)));
      ir_expression *const r0941 = add(r0940, body.constant(2139095040u));
      ir_expression *const r0942 = expr(ir_unop_bitcast_u2f, r0941);
      body.emit(assign(r093D, expr(ir_triop_csel, r093F, r0935, r0942), 0x01));

      body.emit(assign(r0935, r093D, 0x01));

      body.emit(assign(r092C, r093D, 0x01));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f0933->else_instructions;

      ir_variable *const r0943 = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r0944 = lshift(r092E, body.constant(int(10)));
      ir_expression *const r0945 = rshift(r092D, body.constant(int(22)));
      ir_expression *const r0946 = bit_or(r0944, r0945);
      ir_expression *const r0947 = lshift(r092D, body.constant(int(10)));
      ...
      body.emit(assign(r0943, bit_or(r0946, r094A), 0x01));

      ir_variable *const r094B = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r094C = nequal(r092F, body.constant(int(0)));
      ir_expression *const r094D = bit_or(r0943, body.constant(1073741824u));
      body.emit(assign(r094B, expr(ir_triop_csel, r094C, r094D, r0943), 0x01));

      ir_variable *const r094E = body.make_temp(glsl_type::int_type, "zExp");
      body.emit(assign(r094E, add(r092F, body.constant(int(-897))), 0x01));

      ir_variable *const r094F = body.make_temp(glsl_type::uint_type, "zFrac");
      body.emit(assign(r094F, r094B, 0x01));

      ir_variable *const r0950 = body.make_temp(glsl_type::bool_type, "execute_flag");
      body.emit(assign(r0950, body.constant(true), 0x01));

      ir_variable *const r0951 = body.make_temp(glsl_type::float_type, "return_value");
      ir_variable *const r0952 = new(mem_ctx) ir_variable(glsl_type::int_type, "roundBits", ir_var_auto);
      body.emit(r0952);
      ir_expression *const r0953 = bit_and(r094B, body.constant(127u));
      body.emit(assign(r0952, expr(ir_unop_u2i, r0953), 0x01));

      /* IF CONDITION */
      ir_expression *const r0955 = expr(ir_unop_i2u, r094E);
      ir_expression *const r0956 = gequal(r0955, body.constant(253u));
      ir_if *f0954 = new(mem_ctx) ir_if(operand(r0956).val);
      exec_list *const f0954_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r0958 = less(body.constant(int(253)), r094E);
         ir_expression *const r0959 = equal(r094E, body.constant(int(253)));
         ir_expression *const r095A = expr(ir_unop_u2i, r094B);
         ir_expression *const r095B = less(r095A, body.constant(int(-64)));
         ir_expression *const r095C = logic_and(r0959, r095B);
         ir_expression *const r095D = logic_or(r0958, r095C);
         ir_if *f0957 = new(mem_ctx) ir_if(operand(r095D).val);
         exec_list *const f0957_parent_instructions = body.instructions;

            /* THEN INSTRUCTIONS */
            body.instructions = &f0957->then_instructions;

            ir_expression *const r095E = lshift(r0932, body.constant(int(31)));
            ir_expression *const r095F = add(r095E, body.constant(2139095040u));
            body.emit(assign(r0951, expr(ir_unop_bitcast_u2f, r095F), 0x01));

            body.emit(assign(r0950, body.constant(false), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f0957->else_instructions;

            ir_variable *const r0960 = body.make_temp(glsl_type::int_type, "assignment_tmp");
            body.emit(assign(r0960, neg(r094E), 0x01));

            ir_variable *const r0961 = body.make_temp(glsl_type::bool_type, "assignment_tmp");
            body.emit(assign(r0961, less(r094E, body.constant(int(0))), 0x01));

            ir_variable *const r0962 = body.make_temp(glsl_type::uint_type, "mix_retval");
            ir_expression *const r0963 = neg(r094E);
            ir_expression *const r0964 = less(r0963, body.constant(int(32)));
            ir_expression *const r0965 = rshift(r094B, r0960);
            ir_expression *const r0966 = neg(r0960);
            ir_expression *const r0967 = bit_and(r0966, body.constant(int(31)));
            ir_expression *const r0968 = lshift(r094B, r0967);
            ir_expression *const r0969 = nequal(r0968, body.constant(0u));
            ir_expression *const r096A = expr(ir_unop_b2i, r0969);
            ir_expression *const r096B = expr(ir_unop_i2u, r096A);
            ir_expression *const r096C = bit_or(r0965, r096B);
            ir_expression *const r096D = nequal(r094B, body.constant(0u));
            ir_expression *const r096E = expr(ir_unop_b2i, r096D);
            ir_expression *const r096F = expr(ir_unop_i2u, r096E);
            ir_expression *const r0970 = expr(ir_triop_csel, r0964, r096C, r096F);
            body.emit(assign(r0962, expr(ir_triop_csel, r0961, r0970, r094B), 0x01));

            body.emit(assign(r094F, r0962, 0x01));

            ir_expression *const r0971 = expr(ir_unop_u2i, r0962);
            ir_expression *const r0972 = bit_and(r0971, body.constant(int(127)));
            body.emit(assign(r0952, expr(ir_triop_csel, r0961, r0972, r0952), 0x01));

            body.emit(assign(r094E, expr(ir_triop_csel, r0961, body.constant(int(0)), r094E), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f0973 = new(mem_ctx) ir_if(operand(r0950).val);
      exec_list *const f0973_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0973->then_instructions;

         ir_expression *const r0974 = add(r094F, body.constant(64u));
         body.emit(assign(r094F, rshift(r0974, body.constant(int(7))), 0x01));

         ir_expression *const r0975 = bit_xor(r0952, body.constant(int(64)));
         ir_expression *const r0976 = equal(r0975, body.constant(int(0)));
         ir_expression *const r0977 = expr(ir_unop_b2i, r0976);
         ir_expression *const r0978 = expr(ir_unop_i2u, r0977);
         ir_expression *const r0979 = expr(ir_unop_bit_not, r0978);
         body.emit(assign(r094F, bit_and(r094F, r0979), 0x01));

         ir_expression *const r097A = lshift(r0932, body.constant(int(31)));
         ir_expression *const r097B = equal(r094F, body.constant(0u));
         ir_expression *const r097C = expr(ir_triop_csel, r097B, body.constant(int(0)), r094E);
         ir_expression *const r097D = expr(ir_unop_i2u, r097C);
         ir_expression *const r097E = lshift(r097D, body.constant(int(23)));
         ir_expression *const r097F = add(r097A, r097E);
         ir_expression *const r0980 = add(r097F, r094F);
         body.emit(assign(r0951, expr(ir_unop_bitcast_u2f, r0980), 0x01));
      ...
      body.emit(assign(r092C, r0951, 0x01));
...
fp32_to_fp64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r0981 = new(mem_ctx) ir_variable(glsl_type::float_type, "f", ir_var_function_in);
   sig_parameters.push_tail(r0981);
   ...
   ir_variable *const r0984 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aSign", ir_var_auto);
   body.emit(r0984);
   ir_variable *const r0985 = new(mem_ctx) ir_variable(glsl_type::int_type, "aExp", ir_var_auto);
   body.emit(r0985);
   ir_variable *const r0986 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aFrac", ir_var_auto);
   body.emit(r0986);
   ir_variable *const r0987 = body.make_temp(glsl_type::uint_type, "floatBitsToUint_retval");
   body.emit(assign(r0987, expr(ir_unop_bitcast_f2u, r0981), 0x01));

   ir_variable *const r0988 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r0988, bit_and(r0987, body.constant(8388607u)), 0x01));

   body.emit(assign(r0986, r0988, 0x01));

   ir_variable *const r0989 = body.make_temp(glsl_type::int_type, "assignment_tmp");
   ir_expression *const r098A = rshift(r0987, body.constant(int(23)));
   ir_expression *const r098B = bit_and(r098A, body.constant(255u));
   body.emit(assign(r0989, expr(ir_unop_u2i, r098B), 0x01));

   body.emit(assign(r0985, r0989, 0x01));

   body.emit(assign(r0984, rshift(r0987, body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r098D = equal(r0989, body.constant(int(255)));
   ...
   exec_list *const f098C_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r098F = nequal(r0988, body.constant(0u));
      ...
      exec_list *const f098E_parent_instructions = body.instructions;
         ...
         body.emit(assign(r0990, lshift(r0987, body.constant(int(9))), 0x01));

         ir_variable *const r0991 = body.make_temp(glsl_type::uvec2_type, "vec_ctor");
         ir_expression *const r0992 = lshift(r0990, body.constant(int(20)));
         body.emit(assign(r0991, bit_or(r0992, body.constant(0u)), 0x01));

         ir_expression *const r0993 = rshift(r0990, body.constant(int(12)));
         ir_expression *const r0994 = lshift(r0984, body.constant(int(31)));
         ir_expression *const r0995 = bit_or(r0994, body.constant(2146959360u));
         body.emit(assign(r0991, bit_or(r0993, r0995), 0x02));
         ...
         body.emit(r0996);
         ir_expression *const r0997 = lshift(r0984, body.constant(int(31)));
         body.emit(assign(r0996, add(r0997, body.constant(2146435072u)), 0x02));

         body.emit(assign(r0996, body.constant(0u), 0x01));

         body.emit(assign(r0983, r0996, 0x03));
      ...
      /* IF CONDITION */
      ir_expression *const r0999 = equal(r0989, body.constant(int(0)));
      ...
      exec_list *const f0998_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r099B = equal(r0988, body.constant(0u));
         ...
         exec_list *const f099A_parent_instructions = body.instructions;
            ...
            ir_variable *const r099C = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
            body.emit(r099C);
            body.emit(assign(r099C, lshift(r0984, body.constant(int(31))), 0x02));

            body.emit(assign(r099C, body.constant(0u), 0x01));

            body.emit(assign(r0983, r099C, 0x03));
            ...
            ir_expression *const r099E = equal(r0988, body.constant(0u));
            ir_expression *const r099F = expr(ir_unop_find_msb, r0988);
            ir_expression *const r09A0 = sub(body.constant(int(31)), r099F);
            ir_expression *const r09A1 = expr(ir_triop_csel, r099E, body.constant(int(32)), r09A0);
            body.emit(assign(r099D, add(r09A1, body.constant(int(-8))), 0x01));

            body.emit(assign(r0986, lshift(r0988, r099D), 0x01));

            body.emit(assign(r0985, sub(body.constant(int(1)), r099D), 0x01));

            body.emit(assign(r0985, add(r0985, body.constant(int(-1))), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f09A2 = new(mem_ctx) ir_if(operand(r0982).val);
      exec_list *const f09A2_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f09A2->then_instructions;

         ir_variable *const r09A3 = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
         body.emit(r09A3);
         ir_expression *const r09A4 = lshift(r0984, body.constant(int(31)));
         ir_expression *const r09A5 = add(r0985, body.constant(int(896)));
         ir_expression *const r09A6 = expr(ir_unop_i2u, r09A5);
         ir_expression *const r09A7 = lshift(r09A6, body.constant(int(20)));
         ir_expression *const r09A8 = add(r09A4, r09A7);
         ir_expression *const r09A9 = rshift(r0986, body.constant(int(3)));
         body.emit(assign(r09A3, add(r09A8, r09A9), 0x02));

         ir_expression *const r09AA = lshift(r0986, body.constant(int(29)));
         body.emit(assign(r09A3, bit_or(r09AA, body.constant(0u)), 0x01));

         body.emit(assign(r0983, r09A3, 0x03));
...
add96(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r09AB = new(mem_ctx) ir_variable(glsl_type::uint_type, "a0", ir_var_function_in);
   sig_parameters.push_tail(r09AB);
   ir_variable *const r09AC = new(mem_ctx) ir_variable(glsl_type::uint_type, "a1", ir_var_function_in);
   sig_parameters.push_tail(r09AC);
   ir_variable *const r09AD = new(mem_ctx) ir_variable(glsl_type::uint_type, "a2", ir_var_function_in);
   sig_parameters.push_tail(r09AD);
   ir_variable *const r09AE = new(mem_ctx) ir_variable(glsl_type::uint_type, "b0", ir_var_function_in);
   sig_parameters.push_tail(r09AE);
   ir_variable *const r09AF = new(mem_ctx) ir_variable(glsl_type::uint_type, "b1", ir_var_function_in);
   sig_parameters.push_tail(r09AF);
   ir_variable *const r09B0 = new(mem_ctx) ir_variable(glsl_type::uint_type, "b2", ir_var_function_in);
   sig_parameters.push_tail(r09B0);
   ir_variable *const r09B1 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z0Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09B1);
   ir_variable *const r09B2 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z1Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09B2);
   ir_variable *const r09B3 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z2Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09B3);
   ir_variable *const r09B4 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z0", ir_var_auto);
   body.emit(r09B4);
   ir_variable *const r09B5 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z1", ir_var_auto);
   body.emit(r09B5);
   ir_variable *const r09B6 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r09B6, add(r09AD, r09B0), 0x01));

   ir_variable *const r09B7 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   ir_expression *const r09B8 = less(r09B6, r09AD);
   ir_expression *const r09B9 = expr(ir_unop_b2i, r09B8);
   body.emit(assign(r09B7, expr(ir_unop_i2u, r09B9), 0x01));

   ir_variable *const r09BA = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r09BA, add(r09AC, r09AF), 0x01));

   body.emit(assign(r09B5, add(r09BA, r09B7), 0x01));

   ir_expression *const r09BB = add(r09AB, r09AE);
   ir_expression *const r09BC = less(r09B5, r09B7);
   ir_expression *const r09BD = expr(ir_unop_b2i, r09BC);
   ir_expression *const r09BE = expr(ir_unop_i2u, r09BD);
   body.emit(assign(r09B4, add(r09BB, r09BE), 0x01));

   ir_expression *const r09BF = less(r09BA, r09AC);
   ir_expression *const r09C0 = expr(ir_unop_b2i, r09BF);
   ir_expression *const r09C1 = expr(ir_unop_i2u, r09C0);
   body.emit(assign(r09B4, add(r09B4, r09C1), 0x01));

   body.emit(assign(r09B3, r09B6, 0x01));

   body.emit(assign(r09B2, r09B5, 0x01));
...
sub96(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r09C2 = new(mem_ctx) ir_variable(glsl_type::uint_type, "a0", ir_var_function_in);
   sig_parameters.push_tail(r09C2);
   ir_variable *const r09C3 = new(mem_ctx) ir_variable(glsl_type::uint_type, "a1", ir_var_function_in);
   sig_parameters.push_tail(r09C3);
   ir_variable *const r09C4 = new(mem_ctx) ir_variable(glsl_type::uint_type, "a2", ir_var_function_in);
   sig_parameters.push_tail(r09C4);
   ir_variable *const r09C5 = new(mem_ctx) ir_variable(glsl_type::uint_type, "b0", ir_var_function_in);
   sig_parameters.push_tail(r09C5);
   ir_variable *const r09C6 = new(mem_ctx) ir_variable(glsl_type::uint_type, "b1", ir_var_function_in);
   sig_parameters.push_tail(r09C6);
   ir_variable *const r09C7 = new(mem_ctx) ir_variable(glsl_type::uint_type, "b2", ir_var_function_in);
   sig_parameters.push_tail(r09C7);
   ir_variable *const r09C8 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z0Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09C8);
   ir_variable *const r09C9 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z1Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09C9);
   ir_variable *const r09CA = new(mem_ctx) ir_variable(glsl_type::uint_type, "z2Ptr", ir_var_function_inout);
   sig_parameters.push_tail(r09CA);
   ir_variable *const r09CB = new(mem_ctx) ir_variable(glsl_type::uint_type, "z0", ir_var_auto);
   body.emit(r09CB);
   ir_variable *const r09CC = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   ir_expression *const r09CD = less(r09C4, r09C7);
   ir_expression *const r09CE = expr(ir_unop_b2i, r09CD);
   body.emit(assign(r09CC, expr(ir_unop_i2u, r09CE), 0x01));

   ir_variable *const r09CF = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r09CF, sub(r09C3, r09C6), 0x01));

   ir_expression *const r09D0 = sub(r09C2, r09C5);
   ir_expression *const r09D1 = less(r09CF, r09CC);
   ir_expression *const r09D2 = expr(ir_unop_b2i, r09D1);
   ir_expression *const r09D3 = expr(ir_unop_i2u, r09D2);
   body.emit(assign(r09CB, sub(r09D0, r09D3), 0x01));

   ir_expression *const r09D4 = less(r09C3, r09C6);
   ir_expression *const r09D5 = expr(ir_unop_b2i, r09D4);
   ir_expression *const r09D6 = expr(ir_unop_i2u, r09D5);
   body.emit(assign(r09CB, sub(r09CB, r09D6), 0x01));

   body.emit(assign(r09CA, sub(r09C4, r09C7), 0x01));

   body.emit(assign(r09C9, sub(r09CF, r09CC), 0x01));

   body.emit(assign(r09C8, r09CB, 0x01));
...
estimateDiv64To32(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r09D7 = new(mem_ctx) ir_variable(glsl_type::uint_type, "a0", ir_var_function_in);
   sig_parameters.push_tail(r09D7);
   ir_variable *const r09D8 = new(mem_ctx) ir_variable(glsl_type::uint_type, "a1", ir_var_function_in);
   sig_parameters.push_tail(r09D8);
   ir_variable *const r09D9 = new(mem_ctx) ir_variable(glsl_type::uint_type, "b", ir_var_function_in);
   sig_parameters.push_tail(r09D9);
   ir_variable *const r09DA = body.make_temp(glsl_type::uint_type, "return_value");
   ir_variable *const r09DB = new(mem_ctx) ir_variable(glsl_type::uint_type, "z", ir_var_auto);
   body.emit(r09DB);
   ir_variable *const r09DC = new(mem_ctx) ir_variable(glsl_type::uint_type, "rem1", ir_var_auto);
   body.emit(r09DC);
   ir_variable *const r09DD = new(mem_ctx) ir_variable(glsl_type::uint_type, "rem0", ir_var_auto);
   body.emit(r09DD);
   ir_variable *const r09DE = new(mem_ctx) ir_variable(glsl_type::uint_type, "b0", ir_var_auto);
   body.emit(r09DE);
   ...
   /* IF CONDITION */
   ir_expression *const r09E0 = gequal(r09D7, r09D9);
   ...
   exec_list *const f09DF_parent_instructions = body.instructions;
      ...
      body.emit(assign(r09DA, body.constant(4294967295u), 0x01));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f09DF->else_instructions;

      body.emit(assign(r09DE, rshift(r09D9, body.constant(int(16))), 0x01));

      ir_variable *const r09E1 = body.make_temp(glsl_type::uint_type, "conditional_tmp");
      /* IF CONDITION */
      ir_expression *const r09E3 = lshift(r09DE, body.constant(int(16)));
      ir_expression *const r09E4 = gequal(r09D7, r09E3);
      ...
      exec_list *const f09E2_parent_instructions = body.instructions;
         ...
         body.emit(assign(r09E1, body.constant(4294901760u), 0x01));


         /* ELSE INSTRUCTIONS */
         body.instructions = &f09E2->else_instructions;

         ir_expression *const r09E5 = expr(ir_binop_div, r09D7, r09DE);
         body.emit(assign(r09E1, lshift(r09E5, body.constant(int(16))), 0x01));
      ...
      body.emit(assign(r09DB, r09E1, 0x01));

      ir_variable *const r09E6 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z0", ir_var_auto);
      body.emit(r09E6);
      ir_variable *const r09E7 = new(mem_ctx) ir_variable(glsl_type::uint_type, "zMiddleA", ir_var_auto);
      body.emit(r09E7);
      ir_variable *const r09E8 = new(mem_ctx) ir_variable(glsl_type::uint_type, "z1", ir_var_auto);
      body.emit(r09E8);
      ir_variable *const r09E9 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
      body.emit(assign(r09E9, bit_and(r09D9, body.constant(65535u)), 0x01));

      ir_variable *const r09EA = body.make_temp(glsl_type::uint_type, "assignment_tmp");
      body.emit(assign(r09EA, rshift(r09D9, body.constant(int(16))), 0x01));

      ir_variable *const r09EB = body.make_temp(glsl_type::uint_type, "assignment_tmp");
      body.emit(assign(r09EB, bit_and(r09E1, body.constant(65535u)), 0x01));

      ir_variable *const r09EC = body.make_temp(glsl_type::uint_type, "assignment_tmp");
      body.emit(assign(r09EC, rshift(r09E1, body.constant(int(16))), 0x01));

      ir_variable *const r09ED = body.make_temp(glsl_type::uint_type, "assignment_tmp");
      body.emit(assign(r09ED, mul(r09EA, r09EB), 0x01));

      ir_expression *const r09EE = mul(r09E9, r09EC);
      body.emit(assign(r09E7, add(r09EE, r09ED), 0x01));

      ir_expression *const r09EF = mul(r09EA, r09EC);
      ir_expression *const r09F0 = less(r09E7, r09ED);
      ir_expression *const r09F1 = expr(ir_unop_b2i, r09F0);
      ir_expression *const r09F2 = expr(ir_unop_i2u, r09F1);
      ir_expression *const r09F3 = lshift(r09F2, body.constant(int(16)));
      ir_expression *const r09F4 = rshift(r09E7, body.constant(int(16)));
      ir_expression *const r09F5 = add(r09F3, r09F4);
      body.emit(assign(r09E6, add(r09EF, r09F5), 0x01));

      body.emit(assign(r09E7, lshift(r09E7, body.constant(int(16))), 0x01));

      ir_expression *const r09F6 = mul(r09E9, r09EB);
      body.emit(assign(r09E8, add(r09F6, r09E7), 0x01));

      ir_expression *const r09F7 = less(r09E8, r09E7);
      ir_expression *const r09F8 = expr(ir_unop_b2i, r09F7);
      ir_expression *const r09F9 = expr(ir_unop_i2u, r09F8);
      body.emit(assign(r09E6, add(r09E6, r09F9), 0x01));

      ir_expression *const r09FA = sub(r09D7, r09E6);
      ir_expression *const r09FB = less(r09D8, r09E8);
      ir_expression *const r09FC = expr(ir_unop_b2i, r09FB);
      ir_expression *const r09FD = expr(ir_unop_i2u, r09FC);
      body.emit(assign(r09DD, sub(r09FA, r09FD), 0x01));

      body.emit(assign(r09DC, sub(r09D8, r09E8), 0x01));

      /* LOOP BEGIN */
      ir_loop *f09FE = new(mem_ctx) ir_loop();
      exec_list *const f09FE_parent_instructions = body.instructions;

         body.instructions = &f09FE->body_instructions;

         /* IF CONDITION */
         ir_expression *const r0A00 = expr(ir_unop_u2i, r09DD);
         ir_expression *const r0A01 = gequal(r0A00, body.constant(int(0)));
         ir_if *f09FF = new(mem_ctx) ir_if(operand(r0A01).val);
         ...
         body.emit(assign(r09DB, add(r09DB, body.constant(4294901760u)), 0x01));

         ir_variable *const r0A02 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
         ir_expression *const r0A03 = lshift(r09D9, body.constant(int(16)));
         body.emit(assign(r0A02, add(r09DC, r0A03), 0x01));

         ir_expression *const r0A04 = add(r09DD, r09DE);
         ir_expression *const r0A05 = less(r0A02, r09DC);
         ir_expression *const r0A06 = expr(ir_unop_b2i, r0A05);
         ir_expression *const r0A07 = expr(ir_unop_i2u, r0A06);
         body.emit(assign(r09DD, add(r0A04, r0A07), 0x01));

         body.emit(assign(r09DC, r0A02, 0x01));
      ...
      ir_expression *const r0A08 = lshift(r09DD, body.constant(int(16)));
      ir_expression *const r0A09 = rshift(r09DC, body.constant(int(16)));
      body.emit(assign(r09DD, bit_or(r0A08, r0A09), 0x01));

      ir_variable *const r0A0A = body.make_temp(glsl_type::uint_type, "conditional_tmp");
      /* IF CONDITION */
      ir_expression *const r0A0C = lshift(r09DE, body.constant(int(16)));
      ir_expression *const r0A0D = gequal(r09DD, r0A0C);
      ...
      exec_list *const f0A0B_parent_instructions = body.instructions;
         ...
         body.emit(assign(r0A0A, body.constant(65535u), 0x01));


         /* ELSE INSTRUCTIONS */
         body.instructions = &f0A0B->else_instructions;

         body.emit(assign(r0A0A, expr(ir_binop_div, r09DD, r09DE), 0x01));
      ...
      body.emit(assign(r09DB, bit_or(r09DB, r0A0A), 0x01));

      body.emit(assign(r09DA, r09DB, 0x01));
...
fsqrt64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r0A0E = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r0A0E);
   ir_variable *const r0A0F = body.make_temp(glsl_type::uvec2_type, "a");
   body.emit(assign(r0A0F, r0A0E, 0x03));

   ir_variable *const r0A10 = body.make_temp(glsl_type::float_type, "return_value");
   ir_variable *const r0A11 = body.make_temp(glsl_type::uint_type, "extractFloat64FracHi_retval");
   body.emit(assign(r0A11, bit_and(swizzle_y(r0A0E), body.constant(1048575u)), 0x01));

   ir_variable *const r0A12 = body.make_temp(glsl_type::int_type, "extractFloat64Exp_retval");
   ir_expression *const r0A13 = rshift(swizzle_y(r0A0E), body.constant(int(20)));
   ir_expression *const r0A14 = bit_and(r0A13, body.constant(2047u));
   body.emit(assign(r0A12, expr(ir_unop_u2i, r0A14), 0x01));

   ir_variable *const r0A15 = body.make_temp(glsl_type::uint_type, "extractFloat64Sign_retval");
   body.emit(assign(r0A15, rshift(swizzle_y(r0A0E), body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r0A17 = equal(r0A12, body.constant(int(2047)));
   ...
   exec_list *const f0A16_parent_instructions = body.instructions;
      ...
      ir_variable *const r0A18 = new(mem_ctx) ir_variable(glsl_type::float_type, "rval", ir_var_auto);
      body.emit(r0A18);
      ir_expression *const r0A19 = lshift(swizzle_y(r0A0E), body.constant(int(12)));
      ir_expression *const r0A1A = rshift(swizzle_x(r0A0E), body.constant(int(20)));
      body.emit(assign(r0A0F, bit_or(r0A19, r0A1A), 0x02));

      body.emit(assign(r0A0F, lshift(swizzle_x(r0A0E), body.constant(int(12))), 0x01));

      ir_expression *const r0A1B = lshift(r0A15, body.constant(int(31)));
      ir_expression *const r0A1C = bit_or(r0A1B, body.constant(2143289344u));
      ir_expression *const r0A1D = rshift(swizzle_y(r0A0F), body.constant(int(9)));
      ir_expression *const r0A1E = bit_or(r0A1C, r0A1D);
      body.emit(assign(r0A18, expr(ir_unop_bitcast_u2f, r0A1E), 0x01));

      ir_variable *const r0A1F = body.make_temp(glsl_type::float_type, "mix_retval");
      ir_expression *const r0A20 = bit_or(r0A11, swizzle_x(r0A0E));
      ir_expression *const r0A21 = nequal(r0A20, body.constant(0u));
      ir_expression *const r0A22 = lshift(r0A15, body.constant(int(31)));
      ir_expression *const r0A23 = add(r0A22, body.constant(2139095040u));
      ir_expression *const r0A24 = expr(ir_unop_bitcast_u2f, r0A23);
      body.emit(assign(r0A1F, expr(ir_triop_csel, r0A21, r0A18, r0A24), 0x01));

      body.emit(assign(r0A18, r0A1F, 0x01));

      body.emit(assign(r0A10, r0A1F, 0x01));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f0A16->else_instructions;

      ir_variable *const r0A25 = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r0A26 = lshift(r0A11, body.constant(int(10)));
      ir_expression *const r0A27 = rshift(swizzle_x(r0A0E), body.constant(int(22)));
      ir_expression *const r0A28 = bit_or(r0A26, r0A27);
      ir_expression *const r0A29 = lshift(swizzle_x(r0A0E), body.constant(int(10)));
      ...
      body.emit(assign(r0A25, bit_or(r0A28, r0A2C), 0x01));

      ir_variable *const r0A2D = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r0A2E = nequal(r0A12, body.constant(int(0)));
      ir_expression *const r0A2F = bit_or(r0A25, body.constant(1073741824u));
      body.emit(assign(r0A2D, expr(ir_triop_csel, r0A2E, r0A2F, r0A25), 0x01));

      ir_variable *const r0A30 = body.make_temp(glsl_type::int_type, "zExp");
      body.emit(assign(r0A30, add(r0A12, body.constant(int(-897))), 0x01));

      ir_variable *const r0A31 = body.make_temp(glsl_type::uint_type, "zFrac");
      body.emit(assign(r0A31, r0A2D, 0x01));

      ir_variable *const r0A32 = body.make_temp(glsl_type::bool_type, "execute_flag");
      body.emit(assign(r0A32, body.constant(true), 0x01));

      ir_variable *const r0A33 = body.make_temp(glsl_type::float_type, "return_value");
      ir_variable *const r0A34 = new(mem_ctx) ir_variable(glsl_type::int_type, "roundBits", ir_var_auto);
      body.emit(r0A34);
      ir_expression *const r0A35 = bit_and(r0A2D, body.constant(127u));
      body.emit(assign(r0A34, expr(ir_unop_u2i, r0A35), 0x01));

      /* IF CONDITION */
      ir_expression *const r0A37 = expr(ir_unop_i2u, r0A30);
      ir_expression *const r0A38 = gequal(r0A37, body.constant(253u));
      ...
      exec_list *const f0A36_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r0A3A = less(body.constant(int(253)), r0A30);
         ir_expression *const r0A3B = equal(r0A30, body.constant(int(253)));
         ir_expression *const r0A3C = expr(ir_unop_u2i, r0A2D);
         ir_expression *const r0A3D = less(r0A3C, body.constant(int(-64)));
         ir_expression *const r0A3E = logic_and(r0A3B, r0A3D);
         ir_expression *const r0A3F = logic_or(r0A3A, r0A3E);
         ir_if *f0A39 = new(mem_ctx) ir_if(operand(r0A3F).val);
         exec_list *const f0A39_parent_instructions = body.instructions;

            /* THEN INSTRUCTIONS */
            body.instructions = &f0A39->then_instructions;

            ir_expression *const r0A40 = lshift(r0A15, body.constant(int(31)));
            ir_expression *const r0A41 = add(r0A40, body.constant(2139095040u));
            body.emit(assign(r0A33, expr(ir_unop_bitcast_u2f, r0A41), 0x01));

            body.emit(assign(r0A32, body.constant(false), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f0A39->else_instructions;

            ir_variable *const r0A42 = body.make_temp(glsl_type::int_type, "assignment_tmp");
            body.emit(assign(r0A42, neg(r0A30), 0x01));

            ir_variable *const r0A43 = body.make_temp(glsl_type::bool_type, "assignment_tmp");
            body.emit(assign(r0A43, less(r0A30, body.constant(int(0))), 0x01));

            ir_variable *const r0A44 = body.make_temp(glsl_type::uint_type, "mix_retval");
            ir_expression *const r0A45 = neg(r0A30);
            ir_expression *const r0A46 = less(r0A45, body.constant(int(32)));
            ir_expression *const r0A47 = rshift(r0A2D, r0A42);
            ir_expression *const r0A48 = neg(r0A42);
            ir_expression *const r0A49 = bit_and(r0A48, body.constant(int(31)));
            ir_expression *const r0A4A = lshift(r0A2D, r0A49);
            ...
            ir_expression *const r0A4E = bit_or(r0A47, r0A4D);
            ir_expression *const r0A4F = nequal(r0A2D, body.constant(0u));
            ir_expression *const r0A50 = expr(ir_unop_b2i, r0A4F);
            ir_expression *const r0A51 = expr(ir_unop_i2u, r0A50);
            ir_expression *const r0A52 = expr(ir_triop_csel, r0A46, r0A4E, r0A51);
            body.emit(assign(r0A44, expr(ir_triop_csel, r0A43, r0A52, r0A2D), 0x01));

            body.emit(assign(r0A31, r0A44, 0x01));

            ir_expression *const r0A53 = expr(ir_unop_u2i, r0A44);
            ir_expression *const r0A54 = bit_and(r0A53, body.constant(int(127)));
            body.emit(assign(r0A34, expr(ir_triop_csel, r0A43, r0A54, r0A34), 0x01));

            body.emit(assign(r0A30, expr(ir_triop_csel, r0A43, body.constant(int(0)), r0A30), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f0A55 = new(mem_ctx) ir_if(operand(r0A32).val);
      exec_list *const f0A55_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0A55->then_instructions;

         ir_expression *const r0A56 = add(r0A31, body.constant(64u));
         body.emit(assign(r0A31, rshift(r0A56, body.constant(int(7))), 0x01));

         ir_expression *const r0A57 = bit_xor(r0A34, body.constant(int(64)));
         ir_expression *const r0A58 = equal(r0A57, body.constant(int(0)));
         ir_expression *const r0A59 = expr(ir_unop_b2i, r0A58);
         ir_expression *const r0A5A = expr(ir_unop_i2u, r0A59);
         ir_expression *const r0A5B = expr(ir_unop_bit_not, r0A5A);
         body.emit(assign(r0A31, bit_and(r0A31, r0A5B), 0x01));

         ir_expression *const r0A5C = lshift(r0A15, body.constant(int(31)));
         ir_expression *const r0A5D = equal(r0A31, body.constant(0u));
         ir_expression *const r0A5E = expr(ir_triop_csel, r0A5D, body.constant(int(0)), r0A30);
         ir_expression *const r0A5F = expr(ir_unop_i2u, r0A5E);
         ir_expression *const r0A60 = lshift(r0A5F, body.constant(int(23)));
         ir_expression *const r0A61 = add(r0A5C, r0A60);
         ir_expression *const r0A62 = add(r0A61, r0A31);
         body.emit(assign(r0A33, expr(ir_unop_bitcast_u2f, r0A62), 0x01));
      ...
      body.emit(assign(r0A10, r0A33, 0x01));
   ...
   ir_variable *const r0A63 = body.make_temp(glsl_type::bool_type, "execute_flag");
   body.emit(assign(r0A63, body.constant(true), 0x01));

   ir_variable *const r0A64 = body.make_temp(glsl_type::uvec2_type, "return_value");
   ir_variable *const r0A65 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aSign", ir_var_auto);
   body.emit(r0A65);
   ir_variable *const r0A66 = new(mem_ctx) ir_variable(glsl_type::int_type, "aExp", ir_var_auto);
   body.emit(r0A66);
   ir_variable *const r0A67 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aFrac", ir_var_auto);
   body.emit(r0A67);
   ir_variable *const r0A68 = body.make_temp(glsl_type::uint_type, "floatBitsToUint_retval");
   ir_expression *const r0A69 = expr(ir_unop_sqrt, r0A10);
   body.emit(assign(r0A68, expr(ir_unop_bitcast_f2u, r0A69), 0x01));

   ir_variable *const r0A6A = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r0A6A, bit_and(r0A68, body.constant(8388607u)), 0x01));

   body.emit(assign(r0A67, r0A6A, 0x01));

   ir_variable *const r0A6B = body.make_temp(glsl_type::int_type, "assignment_tmp");
   ir_expression *const r0A6C = rshift(r0A68, body.constant(int(23)));
   ir_expression *const r0A6D = bit_and(r0A6C, body.constant(255u));
   body.emit(assign(r0A6B, expr(ir_unop_u2i, r0A6D), 0x01));

   body.emit(assign(r0A66, r0A6B, 0x01));

   body.emit(assign(r0A65, rshift(r0A68, body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r0A6F = equal(r0A6B, body.constant(int(255)));
   ...
   exec_list *const f0A6E_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r0A71 = nequal(r0A6A, body.constant(0u));
      ...
      exec_list *const f0A70_parent_instructions = body.instructions;
         ...
         ir_variable *const r0A72 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
         body.emit(assign(r0A72, lshift(r0A68, body.constant(int(9))), 0x01));

         ir_variable *const r0A73 = body.make_temp(glsl_type::uvec2_type, "vec_ctor");
         ir_expression *const r0A74 = lshift(r0A72, body.constant(int(20)));
         body.emit(assign(r0A73, bit_or(r0A74, body.constant(0u)), 0x01));

         ir_expression *const r0A75 = rshift(r0A72, body.constant(int(12)));
         ir_expression *const r0A76 = lshift(r0A65, body.constant(int(31)));
         ir_expression *const r0A77 = bit_or(r0A76, body.constant(2146959360u));
         body.emit(assign(r0A73, bit_or(r0A75, r0A77), 0x02));

         body.emit(assign(r0A64, r0A73, 0x03));

         body.emit(assign(r0A63, body.constant(false), 0x01));
         ...
         body.emit(r0A78);
         ir_expression *const r0A79 = lshift(r0A65, body.constant(int(31)));
         body.emit(assign(r0A78, add(r0A79, body.constant(2146435072u)), 0x02));

         body.emit(assign(r0A78, body.constant(0u), 0x01));

         body.emit(assign(r0A64, r0A78, 0x03));
      ...
      /* IF CONDITION */
      ir_expression *const r0A7B = equal(r0A6B, body.constant(int(0)));
      ...
      exec_list *const f0A7A_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r0A7D = equal(r0A6A, body.constant(0u));
         ...
         exec_list *const f0A7C_parent_instructions = body.instructions;
            ...
            body.emit(r0A7E);
            body.emit(assign(r0A7E, lshift(r0A65, body.constant(int(31))), 0x02));

            body.emit(assign(r0A7E, body.constant(0u), 0x01));

            body.emit(assign(r0A64, r0A7E, 0x03));
            ...
            ir_variable *const r0A7F = body.make_temp(glsl_type::int_type, "assignment_tmp");
            ir_expression *const r0A80 = equal(r0A6A, body.constant(0u));
            ir_expression *const r0A81 = expr(ir_unop_find_msb, r0A6A);
            ir_expression *const r0A82 = sub(body.constant(int(31)), r0A81);
            ir_expression *const r0A83 = expr(ir_triop_csel, r0A80, body.constant(int(32)), r0A82);
            body.emit(assign(r0A7F, add(r0A83, body.constant(int(-8))), 0x01));

            body.emit(assign(r0A67, lshift(r0A6A, r0A7F), 0x01));

            body.emit(assign(r0A66, sub(body.constant(int(1)), r0A7F), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f0A84 = new(mem_ctx) ir_if(operand(r0A63).val);
      exec_list *const f0A84_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0A84->then_instructions;

         ir_variable *const r0A85 = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
         body.emit(r0A85);
         ir_expression *const r0A86 = lshift(r0A65, body.constant(int(31)));
         ir_expression *const r0A87 = add(r0A66, body.constant(int(896)));
         ir_expression *const r0A88 = expr(ir_unop_i2u, r0A87);
         ir_expression *const r0A89 = lshift(r0A88, body.constant(int(20)));
         ir_expression *const r0A8A = add(r0A86, r0A89);
         ir_expression *const r0A8B = rshift(r0A67, body.constant(int(3)));
         body.emit(assign(r0A85, add(r0A8A, r0A8B), 0x02));

         ir_expression *const r0A8C = lshift(r0A67, body.constant(int(29)));
         body.emit(assign(r0A85, bit_or(r0A8C, body.constant(0u)), 0x01));

         body.emit(assign(r0A64, r0A85, 0x03));

         body.emit(assign(r0A63, body.constant(false), 0x01));


      body.instructions = f0A84_parent_instructions;
      body.emit(f0A84);
...
ftrunc64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r0A8D = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r0A8D);
   ir_variable *const r0A8E = new(mem_ctx) ir_variable(glsl_type::uint_type, "zHi", ir_var_auto);
   body.emit(r0A8E);
   ir_variable *const r0A8F = new(mem_ctx) ir_variable(glsl_type::uint_type, "zLo", ir_var_auto);
   body.emit(r0A8F);
   ir_variable *const r0A90 = body.make_temp(glsl_type::int_type, "assignment_tmp");
   ir_expression *const r0A91 = rshift(swizzle_y(r0A8D), body.constant(int(20)));
   ir_expression *const r0A92 = bit_and(r0A91, body.constant(2047u));
   ir_expression *const r0A93 = expr(ir_unop_u2i, r0A92);
   body.emit(assign(r0A90, add(r0A93, body.constant(int(-1023))), 0x01));

   ir_variable *const r0A94 = body.make_temp(glsl_type::int_type, "assignment_tmp");
   body.emit(assign(r0A94, sub(body.constant(int(52)), r0A90), 0x01));

   ir_variable *const r0A95 = body.make_temp(glsl_type::uint_type, "conditional_tmp");
   /* IF CONDITION */
   ir_expression *const r0A97 = gequal(r0A94, body.constant(int(32)));
   ...
   exec_list *const f0A96_parent_instructions = body.instructions;
      ...
      body.emit(assign(r0A95, lshift(body.constant(4294967295u), r0A94), 0x01));
   ...
   /* IF CONDITION */
   ir_expression *const r0A9A = less(r0A94, body.constant(int(33)));
   ...
   exec_list *const f0A99_parent_instructions = body.instructions;
      ...
      body.emit(assign(r0A98, body.constant(4294967295u), 0x01));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f0A99->else_instructions;

      ir_expression *const r0A9B = add(r0A94, body.constant(int(-32)));
      body.emit(assign(r0A98, lshift(body.constant(4294967295u), r0A9B), 0x01));
   ...
   body.emit(assign(r0A8F, bit_and(r0A95, swizzle_x(r0A8D)), 0x01));

   body.emit(assign(r0A8E, bit_and(r0A98, swizzle_y(r0A8D)), 0x01));

   ir_variable *const r0A9C = body.make_temp(glsl_type::uint_type, "mix_retval");
   ir_expression *const r0A9D = less(body.constant(int(52)), r0A90);
   ir_expression *const r0A9E = less(r0A90, body.constant(int(0)));
   ir_expression *const r0A9F = expr(ir_triop_csel, r0A9E, body.constant(0u), r0A8F);
   body.emit(assign(r0A9C, expr(ir_triop_csel, r0A9D, swizzle_x(r0A8D), r0A9F), 0x01));

   body.emit(assign(r0A8F, r0A9C, 0x01));

   ir_variable *const r0AA0 = body.make_temp(glsl_type::uint_type, "mix_retval");
   ir_expression *const r0AA1 = less(body.constant(int(52)), r0A90);
   ir_expression *const r0AA2 = less(r0A90, body.constant(int(0)));
   ir_expression *const r0AA3 = expr(ir_triop_csel, r0AA2, body.constant(0u), r0A8E);
   body.emit(assign(r0AA0, expr(ir_triop_csel, r0AA1, swizzle_y(r0A8D), r0AA3), 0x01));

   body.emit(assign(r0A8E, r0AA0, 0x01));

   ir_variable *const r0AA4 = body.make_temp(glsl_type::uvec2_type, "vec_ctor");
   body.emit(assign(r0AA4, r0A9C, 0x01));

   body.emit(assign(r0AA4, r0AA0, 0x02));
...
fround64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r0AA5 = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r0AA5);
   ir_variable *const r0AA6 = body.make_temp(glsl_type::bool_type, "execute_flag");
   body.emit(assign(r0AA6, body.constant(true), 0x01));

   ir_variable *const r0AA7 = body.make_temp(glsl_type::uvec2_type, "return_value");
   ir_variable *const r0AA8 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aLo", ir_var_auto);
   body.emit(r0AA8);
   ir_variable *const r0AA9 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aHi", ir_var_auto);
   body.emit(r0AA9);
   ir_variable *const r0AAA = body.make_temp(glsl_type::int_type, "assignment_tmp");
   ir_expression *const r0AAB = rshift(swizzle_y(r0AA5), body.constant(int(20)));
   ir_expression *const r0AAC = bit_and(r0AAB, body.constant(2047u));
   ir_expression *const r0AAD = expr(ir_unop_u2i, r0AAC);
   body.emit(assign(r0AAA, add(r0AAD, body.constant(int(-1023))), 0x01));

   body.emit(assign(r0AA9, swizzle_y(r0AA5), 0x01));

   body.emit(assign(r0AA8, swizzle_x(r0AA5), 0x01));

   /* IF CONDITION */
   ir_expression *const r0AAF = less(r0AAA, body.constant(int(20)));
   ...
   exec_list *const f0AAE_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r0AB1 = less(r0AAA, body.constant(int(0)));
      ir_if *f0AB0 = new(mem_ctx) ir_if(operand(r0AB1).val);
      exec_list *const f0AB0_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0AB0->then_instructions;

         body.emit(assign(r0AA9, bit_and(swizzle_y(r0AA5), body.constant(2147483648u)), 0x01));

         /* IF CONDITION */
         ir_expression *const r0AB3 = equal(r0AAA, body.constant(int(-1)));
         ir_expression *const r0AB4 = nequal(swizzle_x(r0AA5), body.constant(0u));
         ir_expression *const r0AB5 = logic_and(r0AB3, r0AB4);
         ir_if *f0AB2 = new(mem_ctx) ir_if(operand(r0AB5).val);
         exec_list *const f0AB2_parent_instructions = body.instructions;

            /* THEN INSTRUCTIONS */
            body.instructions = &f0AB2->then_instructions;

            body.emit(assign(r0AA9, bit_or(r0AA9, body.constant(1072693248u)), 0x01));
         ...
         /* ELSE INSTRUCTIONS */
         body.instructions = &f0AB0->else_instructions;

         ir_variable *const r0AB6 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
         body.emit(assign(r0AB6, rshift(body.constant(1048575u), r0AAA), 0x01));

         /* IF CONDITION */
         ir_expression *const r0AB8 = bit_and(r0AA9, r0AB6);
         ir_expression *const r0AB9 = equal(r0AB8, body.constant(0u));
         ir_expression *const r0ABA = equal(r0AA8, body.constant(0u));
         ir_expression *const r0ABB = logic_and(r0AB9, r0ABA);
         ir_if *f0AB7 = new(mem_ctx) ir_if(operand(r0ABB).val);
         exec_list *const f0AB7_parent_instructions = body.instructions;

            /* THEN INSTRUCTIONS */
            body.instructions = &f0AB7->then_instructions;

            body.emit(assign(r0AA7, r0AA5, 0x03));

            body.emit(assign(r0AA6, body.constant(false), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f0AB7->else_instructions;

            ir_expression *const r0ABC = rshift(body.constant(524288u), r0AAA);
            body.emit(assign(r0AA9, add(r0AA9, r0ABC), 0x01));

            ir_expression *const r0ABD = expr(ir_unop_bit_not, r0AB6);
            body.emit(assign(r0AA9, bit_and(r0AA9, r0ABD), 0x01));

            body.emit(assign(r0AA8, body.constant(0u), 0x01));


         body.instructions = f0AB7_parent_instructions;
         body.emit(f0AB7);
      ...
      /* IF CONDITION */
      ir_expression *const r0ABF = less(body.constant(int(51)), r0AAA);
      ir_expression *const r0AC0 = equal(r0AAA, body.constant(int(1024)));
      ir_expression *const r0AC1 = logic_or(r0ABF, r0AC0);
      ir_if *f0ABE = new(mem_ctx) ir_if(operand(r0AC1).val);
      exec_list *const f0ABE_parent_instructions = body.instructions;
         ...
         ir_expression *const r0AC3 = add(r0AAA, body.constant(int(-20)));
         body.emit(assign(r0AC2, rshift(body.constant(4294967295u), r0AC3), 0x01));

         /* IF CONDITION */
         ir_expression *const r0AC5 = bit_and(r0AA8, r0AC2);
         ir_expression *const r0AC6 = equal(r0AC5, body.constant(0u));
         ir_if *f0AC4 = new(mem_ctx) ir_if(operand(r0AC6).val);
         exec_list *const f0AC4_parent_instructions = body.instructions;
            ...
            ir_variable *const r0AC7 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
            ir_expression *const r0AC8 = sub(body.constant(int(51)), r0AAA);
            ir_expression *const r0AC9 = lshift(body.constant(1u), r0AC8);
            body.emit(assign(r0AC7, add(r0AA8, r0AC9), 0x01));

            /* IF CONDITION */
            ir_expression *const r0ACB = less(r0AC7, r0AA8);
            ...
            exec_list *const f0ACA_parent_instructions = body.instructions;
               ...
               body.emit(assign(r0AA9, add(r0AA9, body.constant(1u)), 0x01));
            ...
            ir_expression *const r0ACC = expr(ir_unop_bit_not, r0AC2);
            body.emit(assign(r0AA8, bit_and(r0AC7, r0ACC), 0x01));
   ...
   /* IF CONDITION */
   ir_if *f0ACD = new(mem_ctx) ir_if(operand(r0AA6).val);
   exec_list *const f0ACD_parent_instructions = body.instructions;

      /* THEN INSTRUCTIONS */
      body.instructions = &f0ACD->then_instructions;

      body.emit(assign(r0AA5, r0AA8, 0x01));

      body.emit(assign(r0AA5, r0AA9, 0x02));
...
frcp64(void *mem_ctx, builtin_available_predicate avail)
{
   ...
   ir_variable *const r0ACE = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "a", ir_var_function_in);
   sig_parameters.push_tail(r0ACE);
   ir_variable *const r0ACF = body.make_temp(glsl_type::uvec2_type, "a");
   body.emit(assign(r0ACF, r0ACE, 0x03));

   ir_variable *const r0AD0 = body.make_temp(glsl_type::float_type, "return_value");
   ir_variable *const r0AD1 = body.make_temp(glsl_type::uint_type, "extractFloat64FracHi_retval");
   body.emit(assign(r0AD1, bit_and(swizzle_y(r0ACE), body.constant(1048575u)), 0x01));

   ir_variable *const r0AD2 = body.make_temp(glsl_type::int_type, "extractFloat64Exp_retval");
   ir_expression *const r0AD3 = rshift(swizzle_y(r0ACE), body.constant(int(20)));
   ir_expression *const r0AD4 = bit_and(r0AD3, body.constant(2047u));
   body.emit(assign(r0AD2, expr(ir_unop_u2i, r0AD4), 0x01));

   ir_variable *const r0AD5 = body.make_temp(glsl_type::uint_type, "extractFloat64Sign_retval");
   body.emit(assign(r0AD5, rshift(swizzle_y(r0ACE), body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r0AD7 = equal(r0AD2, body.constant(int(2047)));
   ...
   exec_list *const f0AD6_parent_instructions = body.instructions;
      ...
      ir_variable *const r0AD8 = new(mem_ctx) ir_variable(glsl_type::float_type, "rval", ir_var_auto);
      body.emit(r0AD8);
      ir_expression *const r0AD9 = lshift(swizzle_y(r0ACE), body.constant(int(12)));
      ir_expression *const r0ADA = rshift(swizzle_x(r0ACE), body.constant(int(20)));
      body.emit(assign(r0ACF, bit_or(r0AD9, r0ADA), 0x02));

      body.emit(assign(r0ACF, lshift(swizzle_x(r0ACE), body.constant(int(12))), 0x01));

      ir_expression *const r0ADB = lshift(r0AD5, body.constant(int(31)));
      ir_expression *const r0ADC = bit_or(r0ADB, body.constant(2143289344u));
      ir_expression *const r0ADD = rshift(swizzle_y(r0ACF), body.constant(int(9)));
      ir_expression *const r0ADE = bit_or(r0ADC, r0ADD);
      body.emit(assign(r0AD8, expr(ir_unop_bitcast_u2f, r0ADE), 0x01));

      ir_variable *const r0ADF = body.make_temp(glsl_type::float_type, "mix_retval");
      ir_expression *const r0AE0 = bit_or(r0AD1, swizzle_x(r0ACE));
      ir_expression *const r0AE1 = nequal(r0AE0, body.constant(0u));
      ir_expression *const r0AE2 = lshift(r0AD5, body.constant(int(31)));
      ir_expression *const r0AE3 = add(r0AE2, body.constant(2139095040u));
      ir_expression *const r0AE4 = expr(ir_unop_bitcast_u2f, r0AE3);
      body.emit(assign(r0ADF, expr(ir_triop_csel, r0AE1, r0AD8, r0AE4), 0x01));

      body.emit(assign(r0AD8, r0ADF, 0x01));

      body.emit(assign(r0AD0, r0ADF, 0x01));


      /* ELSE INSTRUCTIONS */
      body.instructions = &f0AD6->else_instructions;

      ir_variable *const r0AE5 = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r0AE6 = lshift(r0AD1, body.constant(int(10)));
      ir_expression *const r0AE7 = rshift(swizzle_x(r0ACE), body.constant(int(22)));
      ir_expression *const r0AE8 = bit_or(r0AE6, r0AE7);
      ir_expression *const r0AE9 = lshift(swizzle_x(r0ACE), body.constant(int(10)));
      ...
      body.emit(assign(r0AE5, bit_or(r0AE8, r0AEC), 0x01));

      ir_variable *const r0AED = body.make_temp(glsl_type::uint_type, "mix_retval");
      ir_expression *const r0AEE = nequal(r0AD2, body.constant(int(0)));
      ir_expression *const r0AEF = bit_or(r0AE5, body.constant(1073741824u));
      body.emit(assign(r0AED, expr(ir_triop_csel, r0AEE, r0AEF, r0AE5), 0x01));

      ir_variable *const r0AF0 = body.make_temp(glsl_type::int_type, "zExp");
      body.emit(assign(r0AF0, add(r0AD2, body.constant(int(-897))), 0x01));

      ir_variable *const r0AF1 = body.make_temp(glsl_type::uint_type, "zFrac");
      body.emit(assign(r0AF1, r0AED, 0x01));

      ir_variable *const r0AF2 = body.make_temp(glsl_type::bool_type, "execute_flag");
      body.emit(assign(r0AF2, body.constant(true), 0x01));

      ir_variable *const r0AF3 = body.make_temp(glsl_type::float_type, "return_value");
      ir_variable *const r0AF4 = new(mem_ctx) ir_variable(glsl_type::int_type, "roundBits", ir_var_auto);
      body.emit(r0AF4);
      ir_expression *const r0AF5 = bit_and(r0AED, body.constant(127u));
      body.emit(assign(r0AF4, expr(ir_unop_u2i, r0AF5), 0x01));

      /* IF CONDITION */
      ir_expression *const r0AF7 = expr(ir_unop_i2u, r0AF0);
      ir_expression *const r0AF8 = gequal(r0AF7, body.constant(253u));
      ir_if *f0AF6 = new(mem_ctx) ir_if(operand(r0AF8).val);
      exec_list *const f0AF6_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r0AFA = less(body.constant(int(253)), r0AF0);
         ir_expression *const r0AFB = equal(r0AF0, body.constant(int(253)));
         ir_expression *const r0AFC = expr(ir_unop_u2i, r0AED);
         ir_expression *const r0AFD = less(r0AFC, body.constant(int(-64)));
         ir_expression *const r0AFE = logic_and(r0AFB, r0AFD);
         ir_expression *const r0AFF = logic_or(r0AFA, r0AFE);
         ir_if *f0AF9 = new(mem_ctx) ir_if(operand(r0AFF).val);
         exec_list *const f0AF9_parent_instructions = body.instructions;

            /* THEN INSTRUCTIONS */
            body.instructions = &f0AF9->then_instructions;

            ir_expression *const r0B00 = lshift(r0AD5, body.constant(int(31)));
            ir_expression *const r0B01 = add(r0B00, body.constant(2139095040u));
            body.emit(assign(r0AF3, expr(ir_unop_bitcast_u2f, r0B01), 0x01));

            body.emit(assign(r0AF2, body.constant(false), 0x01));


            /* ELSE INSTRUCTIONS */
            body.instructions = &f0AF9->else_instructions;

            ir_variable *const r0B02 = body.make_temp(glsl_type::int_type, "assignment_tmp");
            body.emit(assign(r0B02, neg(r0AF0), 0x01));

            ir_variable *const r0B03 = body.make_temp(glsl_type::bool_type, "assignment_tmp");
            body.emit(assign(r0B03, less(r0AF0, body.constant(int(0))), 0x01));

            ir_variable *const r0B04 = body.make_temp(glsl_type::uint_type, "mix_retval");
            ir_expression *const r0B05 = neg(r0AF0);
            ir_expression *const r0B06 = less(r0B05, body.constant(int(32)));
            ir_expression *const r0B07 = rshift(r0AED, r0B02);
            ir_expression *const r0B08 = neg(r0B02);
            ir_expression *const r0B09 = bit_and(r0B08, body.constant(int(31)));
            ir_expression *const r0B0A = lshift(r0AED, r0B09);
            ir_expression *const r0B0B = nequal(r0B0A, body.constant(0u));
            ir_expression *const r0B0C = expr(ir_unop_b2i, r0B0B);
            ir_expression *const r0B0D = expr(ir_unop_i2u, r0B0C);
            ir_expression *const r0B0E = bit_or(r0B07, r0B0D);
            ir_expression *const r0B0F = nequal(r0AED, body.constant(0u));
            ir_expression *const r0B10 = expr(ir_unop_b2i, r0B0F);
            ir_expression *const r0B11 = expr(ir_unop_i2u, r0B10);
            ir_expression *const r0B12 = expr(ir_triop_csel, r0B06, r0B0E, r0B11);
            body.emit(assign(r0B04, expr(ir_triop_csel, r0B03, r0B12, r0AED), 0x01));

            body.emit(assign(r0AF1, r0B04, 0x01));

            ir_expression *const r0B13 = expr(ir_unop_u2i, r0B04);
            ir_expression *const r0B14 = bit_and(r0B13, body.constant(int(127)));
            body.emit(assign(r0AF4, expr(ir_triop_csel, r0B03, r0B14, r0AF4), 0x01));

            body.emit(assign(r0AF0, expr(ir_triop_csel, r0B03, body.constant(int(0)), r0AF0), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f0B15 = new(mem_ctx) ir_if(operand(r0AF2).val);
      exec_list *const f0B15_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0B15->then_instructions;

         ir_expression *const r0B16 = add(r0AF1, body.constant(64u));
         body.emit(assign(r0AF1, rshift(r0B16, body.constant(int(7))), 0x01));

         ir_expression *const r0B17 = bit_xor(r0AF4, body.constant(int(64)));
         ir_expression *const r0B18 = equal(r0B17, body.constant(int(0)));
         ir_expression *const r0B19 = expr(ir_unop_b2i, r0B18);
         ir_expression *const r0B1A = expr(ir_unop_i2u, r0B19);
         ir_expression *const r0B1B = expr(ir_unop_bit_not, r0B1A);
         body.emit(assign(r0AF1, bit_and(r0AF1, r0B1B), 0x01));

         ir_expression *const r0B1C = lshift(r0AD5, body.constant(int(31)));
         ir_expression *const r0B1D = equal(r0AF1, body.constant(0u));
         ir_expression *const r0B1E = expr(ir_triop_csel, r0B1D, body.constant(int(0)), r0AF0);
         ir_expression *const r0B1F = expr(ir_unop_i2u, r0B1E);
         ir_expression *const r0B20 = lshift(r0B1F, body.constant(int(23)));
         ir_expression *const r0B21 = add(r0B1C, r0B20);
         ir_expression *const r0B22 = add(r0B21, r0AF1);
         body.emit(assign(r0AF3, expr(ir_unop_bitcast_u2f, r0B22), 0x01));
      ...
      body.emit(assign(r0AD0, r0AF3, 0x01));
   ...
   ir_variable *const r0B24 = body.make_temp(glsl_type::uvec2_type, "return_value");
   ir_variable *const r0B25 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aSign", ir_var_auto);
   body.emit(r0B25);
   ir_variable *const r0B26 = new(mem_ctx) ir_variable(glsl_type::int_type, "aExp", ir_var_auto);
   body.emit(r0B26);
   ir_variable *const r0B27 = new(mem_ctx) ir_variable(glsl_type::uint_type, "aFrac", ir_var_auto);
   body.emit(r0B27);
   ir_variable *const r0B28 = body.make_temp(glsl_type::uint_type, "floatBitsToUint_retval");
   ir_expression *const r0B29 = expr(ir_unop_rcp, r0AD0);
   body.emit(assign(r0B28, expr(ir_unop_bitcast_f2u, r0B29), 0x01));

   ir_variable *const r0B2A = body.make_temp(glsl_type::uint_type, "assignment_tmp");
   body.emit(assign(r0B2A, bit_and(r0B28, body.constant(8388607u)), 0x01));

   body.emit(assign(r0B27, r0B2A, 0x01));

   ir_variable *const r0B2B = body.make_temp(glsl_type::int_type, "assignment_tmp");
   ir_expression *const r0B2C = rshift(r0B28, body.constant(int(23)));
   ir_expression *const r0B2D = bit_and(r0B2C, body.constant(255u));
   body.emit(assign(r0B2B, expr(ir_unop_u2i, r0B2D), 0x01));

   body.emit(assign(r0B26, r0B2B, 0x01));

   body.emit(assign(r0B25, rshift(r0B28, body.constant(int(31))), 0x01));

   /* IF CONDITION */
   ir_expression *const r0B2F = equal(r0B2B, body.constant(int(255)));
   ...
   exec_list *const f0B2E_parent_instructions = body.instructions;
      ...
      /* IF CONDITION */
      ir_expression *const r0B31 = nequal(r0B2A, body.constant(0u));
      ...
      exec_list *const f0B30_parent_instructions = body.instructions;
         ...
         ir_variable *const r0B32 = body.make_temp(glsl_type::uint_type, "assignment_tmp");
         body.emit(assign(r0B32, lshift(r0B28, body.constant(int(9))), 0x01));

         ir_variable *const r0B33 = body.make_temp(glsl_type::uvec2_type, "vec_ctor");
         ir_expression *const r0B34 = lshift(r0B32, body.constant(int(20)));
         body.emit(assign(r0B33, bit_or(r0B34, body.constant(0u)), 0x01));

         ir_expression *const r0B35 = rshift(r0B32, body.constant(int(12)));
         ir_expression *const r0B36 = lshift(r0B25, body.constant(int(31)));
         ir_expression *const r0B37 = bit_or(r0B36, body.constant(2146959360u));
         body.emit(assign(r0B33, bit_or(r0B35, r0B37), 0x02));

         body.emit(assign(r0B24, r0B33, 0x03));
         ...
         ir_variable *const r0B38 = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
         body.emit(r0B38);
         ir_expression *const r0B39 = lshift(r0B25, body.constant(int(31)));
         body.emit(assign(r0B38, add(r0B39, body.constant(2146435072u)), 0x02));

         body.emit(assign(r0B38, body.constant(0u), 0x01));

         body.emit(assign(r0B24, r0B38, 0x03));
      ...
      /* IF CONDITION */
      ir_expression *const r0B3B = equal(r0B2B, body.constant(int(0)));
      ...
      exec_list *const f0B3A_parent_instructions = body.instructions;
         ...
         /* IF CONDITION */
         ir_expression *const r0B3D = equal(r0B2A, body.constant(0u));
         ...
         exec_list *const f0B3C_parent_instructions = body.instructions;
            ...
            ir_variable *const r0B3E = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
            body.emit(r0B3E);
            body.emit(assign(r0B3E, lshift(r0B25, body.constant(int(31))), 0x02));

            body.emit(assign(r0B3E, body.constant(0u), 0x01));

            body.emit(assign(r0B24, r0B3E, 0x03));
            ...
            ir_expression *const r0B40 = equal(r0B2A, body.constant(0u));
            ir_expression *const r0B41 = expr(ir_unop_find_msb, r0B2A);
            ir_expression *const r0B42 = sub(body.constant(int(31)), r0B41);
            ir_expression *const r0B43 = expr(ir_triop_csel, r0B40, body.constant(int(32)), r0B42);
            body.emit(assign(r0B3F, add(r0B43, body.constant(int(-8))), 0x01));

            body.emit(assign(r0B27, lshift(r0B2A, r0B3F), 0x01));

            body.emit(assign(r0B26, sub(body.constant(int(1)), r0B3F), 0x01));

            body.emit(assign(r0B26, add(r0B26, body.constant(int(-1))), 0x01));
      ...
      /* IF CONDITION */
      ir_if *f0B44 = new(mem_ctx) ir_if(operand(r0B23).val);
      exec_list *const f0B44_parent_instructions = body.instructions;

         /* THEN INSTRUCTIONS */
         body.instructions = &f0B44->then_instructions;

         ir_variable *const r0B45 = new(mem_ctx) ir_variable(glsl_type::uvec2_type, "z", ir_var_auto);
         body.emit(r0B45);
         ir_expression *const r0B46 = lshift(r0B25, body.constant(int(31)));
         ir_expression *const r0B47 = add(r0B26, body.constant(int(896)));
         ir_expression *const r0B48 = expr(ir_unop_i2u, r0B47);
         ir_expression *const r0B49 = lshift(r0B48, body.constant(int(20)));
         ir_expression *const r0B4A = add(r0B46, r0B49);
         ir_expression *const r0B4B = rshift(r0B27, body.constant(int(3)));
         body.emit(assign(r0B45, add(r0B4A, r0B4B), 0x02));

         ir_expression *const r0B4C = lshift(r0B27, body.constant(int(29)));
         body.emit(assign(r0B45, bit_or(r0B4C, body.constant(0u)), 0x01));

         body.emit(assign(r0B24, r0B45, 0x03));
